...
interface EmployeeEmailDialogProps {
  open: boolean;
...
export function EmployeeEmailDialog({
  open,
  onOpenChange,
  employeeId,
  employeeName,
  bhpEmail,
}: EmployeeEmailDialogProps) {
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch(
        `/api/employees/${employeeId}/send-email`,
        {
          method: "POST",
      ...
      toast({
        title: "Email Sent",
        description: `Employee notification sent successfully`,
      });
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Send notification for <strong>{employeeName}</strong>
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">(BHP)</span>
            </div>
          </div>
