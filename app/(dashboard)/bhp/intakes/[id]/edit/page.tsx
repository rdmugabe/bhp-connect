...
export default function BHPEditIntakePage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            Edit Intake Assessment
          </h1>
          <p className="text-muted-foreground">
            Editing intake for {intake.residentName}
            {intake.facility && ` - ${intake.facility.name}`}
          </p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
        ...
        <div>
          <p className="font-medium text-blue-800">Edit Mode</p>
          <p className="text-sm text-blue-700">
            You are editing an intake as a BHP. Changes will be saved when you click &quot;Save Changes&quot;.
          </p>
        </div>
      </div>
