      ...
      if (bhpProfile) {
        ...
        expiringCredentials.forEach((cred) => {
          notifications.push({
            ...
            description: `${cred.name} expires on ${cred.expiresAt?.toLocaleDateString("en-US", { timeZone: "UTC" })}`,
      ...
      if (bhrfProfile) {
        ...
        expiringEmployeeDocs.forEach((doc) => {
          notifications.push({
            ...
            description: `${doc.employee.firstName} ${doc.employee.lastName}'s ${doc.documentType.name} expires on ${doc.expiresAt?.toLocaleDateString("en-US", { timeZone: "UTC" })}`,
